...
const Card = ({
  ...
  return (
    <div
      className="bg-[#F0D1A8] rounded-md  w-[210px] flex justify-between p-5 mt-[20px] w-full"
      style={{
    ...
    >
      <div>
        ...
        <p
          ...
          className="text-[#4B332F] text-sm p-1"
        >
          {detail}
        </p>
        ...
        <p
          ...
          className="text-[#4B332F] text-sm p-1"
        >
          {mockCategory.find((c) => c.value === category)?.label}
        </p>
      ...
      <div className="mt-2 flex flex-col items-center pl-4">
        <p
          ...
          className="text-[#4B332F] text-sm p-1"
        >
          {mockPriority.find((p) => p.value === priority)?.label}
        </p>
